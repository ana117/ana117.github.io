<section id="hero"
    ...
    <div class="flex justify-center items-center grow w-fit relative z-0">
        ...
        <h1 class="absolute font-bold text-[3rem] md:text-[4rem]
                   text-center text-primary dark:text-secondary whitespace-pre-line">
            <span class="text-[2rem] md:text-[2.5rem] align-top">Greetings Human,</span>
            I'm Naufan
        </h1>
    </div>
    <a href="#content">
        <img src="/assets/icons/down_arrow.svg" alt="down arrow"
             class="w-[6rem] md:w-[5rem] grow-0 animate-bounce dark:hidden">
        <img src="/assets/icons/down_arrow_light.svg" alt="down arrow"
             class="w-[6rem] md:w-[5rem] grow-0 animate-bounce hidden dark:block">
    </a>
</section>